...
## Project Structure
    ...
    ├── testapiautocatalog_112618  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_112618`
...
2. Clone this repo and `cd testapiautocatalog_112618`
